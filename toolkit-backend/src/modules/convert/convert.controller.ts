  ...
  getConfig = (req: Request, res: Response): void => {
    const config: ConfigResponseDto = {
      supportedColumnTypes: [
        { value: ColumnType.CATEGORY_ID, label: 'Category ID', labelRu: 'ID категории', description: 'ID of the category', filter: "category" },
        { value: ColumnType.CATEGORY_NAME, label: 'Category', labelRu: 'Имя категории', description: 'Product category name', filter: "category" },
        ...
        { value: ColumnType.SUBCATEGORY_ID, label: 'Subcategory ID', labelRu: 'ID подкатегории', description: 'ID of the subcategory', filter: "category" },
        { value: ColumnType.PRODUCT_ID, label: 'Product ID', labelRu: 'ID товара', description: 'ID of the product', filter: "product" },
