...
const emit = defineEmits<{
  (e: "select-range", value: TypesAnalizateXml.XmlRange): void;
}>();
</script>
            ...
            <DisclosurePanel>
              <ul class="schema__list">
                <li class="schema__list-item" v-for="item in props.meta.modifiersGroups.names" :key="item.name" >
                  <button class="schema__btn" @click="item.range ? emit('select-range', item.range) : null">{{ item.name }}</button>
                </li>
              </ul>
              <span>&lt;/names&gt;</span>
            </DisclosurePanel>
      ...
      <DisclosurePanel>
        <div class="schema__wrapper">
          ...
          <Disclosure>
            ...
            <DisclosurePanel>
              <div class="schema__wrapper">
                <span>true - {{ props.meta.offers.description.true }}/{{ props.meta.offers.quantity }}</span>
                <span>false - {{ props.meta.offers.description.false }}/{{ props.meta.offers.quantity }}</span>
              </div>
          ...
          <Disclosure>
            ...
            <DisclosurePanel>
              <div class="schema__wrapper">
                <span>true - {{ props.meta.offers.picture.true }}/{{ props.meta.offers.quantity }}</span>
                <span>false - {{ props.meta.offers.picture.false }}/{{ props.meta.offers.quantity }}</span>
              </div>
              <span>&lt;/picture&gt;</span>
            </DisclosurePanel>
          </Disclosure>
            ...
            <DisclosurePanel>
              <div class="schema__wrapper">
                <Disclosure>
                  ...
                  <DisclosurePanel>
                    <div class="schema__wrapper">
                      <span>true - {{ props.meta.offers.parameters.price.true }}/{{
                        props.meta.offers.parameters.quantity
                        }}</span>
                      <span>false - {{ props.meta.offers.parameters.price.false }}/{{
                        props.meta.offers.parameters.quantity
                        }}</span>
                    </div>
                    <span>&lt;/price&gt;</span>
                ...
                <Disclosure>
                  ...
                  <DisclosurePanel>
                    <div class="schema__wrapper">
                      <span>true - {{ props.meta.offers.parameters.description.true }}/{{
                        props.meta.offers.parameters.quantity }}</span>
                      <span>false - {{ props.meta.offers.parameters.description.false }}/{{
                        props.meta.offers.parameters.quantity }}</span>
                    </div>
                    <span>&lt;/description&gt;</span>
                  </DisclosurePanel>
                ...
                <Disclosure>
                  ...
                  <DisclosurePanel>
                    <div class="schema__wrapper">
                      <span>true - {{ props.meta.offers.parameters.descriptionIndex.true }}/{{
                        props.meta.offers.parameters.quantity }}</span>
                      <span>false - {{ props.meta.offers.parameters.descriptionIndex.false }}/{{
                        props.meta.offers.parameters.quantity }}</span>
                    </div>
          ...
          <Disclosure v-for="param in props.meta.offers.parameters.data" :key="param.quantityParams">
            ...
            <DisclosurePanel>
              <ul class="schema__list">
                <li class="schema__list-item" v-for="name in param.offers" :key="name">
                  {{ name }}
                </li>
              </ul>
            </DisclosurePanel>
